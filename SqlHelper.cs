...
{/// <summary>
 ...
 /// <returns></returns>
    ...
    /// <param name="paramValue"></param>
    /// <returns></returns>
    public static DbCommand Params(this DbCommand cmd, string paramName, Action<DbParameter> configureParam = null)
    {
        if (string.IsNullOrEmpty(cmd.CommandText) && cmd.CommandType != System.Data.CommandType.StoredProcedure)
            throw new InvalidOperationException("Call LoadStoredProc before using this method");
    ...
    /// <param name="paramValue"></param>
    /// <returns></returns>
    public static DbCommand Params(this DbCommand cmd, string paramName, SqlParameter parameter)
    {
        if (string.IsNullOrEmpty(cmd.CommandText) && cmd.CommandType != System.Data.CommandType.StoredProcedure)
            throw new InvalidOperationException("Call LoadStoredProc before using this method");
